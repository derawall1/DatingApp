...
namespace API.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        public async Task<ActionResult<PhotoDto>> AddPhoto(IFormFile file)
        {
            ...
            return BadRequest("Problem in photo upload service");
        }
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            photo.IsMain = true;
            if (await _userRepository.SaveAllAsync()) return Ok("Photo updated to main successfully!");
        ...
        public async Task<ActionResult> Delete(int photoId)
        {
            ...
            if (await _userRepository.SaveAllAsync()) return Ok("Selected photo has been deleted successfully!");
